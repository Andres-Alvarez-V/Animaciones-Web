...
const $bell = document.getElementById('notification')
    $button.addEventListener('click', (event) =>{
        const count = Number($bell.getAttribute('data-count')) || 0; // si el data-coint no tiene ningun valor me retorna null por lo cual le digo con || que le asigne valor 0
...
const btnNotication = document.getElementById("btnNotify");
...
btnNotication.addEventListener("transitionend", () => activarIdSeccion(event, 0))
btnOlas.addEventListener("transitionend", () => activarIdSeccion(event, 1))
